...
namespace LiveSplit.OriAndTheBlindForest
{
    ...
    public class OutlinedTextBlock : FrameworkElement
    {
        ...
        public static readonly DependencyProperty TextWrappingProperty = DependencyProperty.Register("TextWrapping", typeof(TextWrapping), typeof(OutlinedTextBlock), new FrameworkPropertyMetadata(TextWrapping.Wrap, OnFormattedTextUpdated));
        public static readonly DependencyProperty NormalTextProperty = DependencyProperty.Register("NormalText", typeof(bool), typeof(OutlinedTextBlock), new FrameworkPropertyMetadata(false, OnFormattedTextUpdated));
        public static readonly DependencyProperty IncludeBorderProperty = DependencyProperty.Register("IncludeBorder", typeof(bool), typeof(OutlinedTextBlock), new FrameworkPropertyMetadata(false, OnFormattedTextUpdated));
        ...
        public FormattedText Object { get { return _formattedText; } }
        public Brush Fill {
        ...
        public bool NormalText {
            get { return (bool)GetValue(NormalTextProperty); }
            set { SetValue(NormalTextProperty, value); }
        }

        public bool IncludeBorder {
            get { return (bool)GetValue(IncludeBorderProperty); }
            set { SetValue(IncludeBorderProperty, value); }
        }
            ...
            if (!NormalText) {
                for (var x = -outlineWidth; x <= outlineWidth; x += step) {
                    for (var y = -outlineWidth; y <= outlineWidth; y += step) {
                        if (x != 0 || y != 0)
                            drawingContext.DrawText(_formattedText, new Point(x + (IncludeBorder ? 12 : 0), y));
                    }
                }
            }

            _formattedText.SetForegroundBrush(Fill);
            drawingContext.DrawText(_formattedText, new Point(IncludeBorder ? 12 : 0, 0));
        }
        ...
        protected override Size MeasureOverride(Size availableSize) {
            ...
            return new Size(_formattedText.Width + (IncludeBorder ? 24 : 0), _formattedText.Height + (IncludeBorder ? 4 : 0));
        }
